...
import com.yx.chatrobot.ui.history.HistoryScreen
...
sealed class Screen(
    ...
    object HistoryPage : Screen("history", "历史会话", Icons.Filled.List, {
        HistoryScreen()
    })
}

val screens = listOf<Screen>(Screen.HomePage, Screen.SettingPage, Screen.HistoryPage)