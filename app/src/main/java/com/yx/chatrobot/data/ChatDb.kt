...
@Database(
    entities = [Message::class, User::class, Config::class, com.yx.chatrobot.data.entity.Conversation::class],
    version = 10,
    exportSchema = false
)
abstract class ChatDb : RoomDatabase() {
    ...
    abstract val conversationDao: com.yx.chatrobot.data.dao.ConversationDao
